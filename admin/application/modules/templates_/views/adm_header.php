  ...
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="<?php echo base_url('dashboard') ?>" class="site_title">
        <!-- <i class="fa fa-paw"></i> --><img src="<?php echo base_url() ?>assets/frontend/images/icons/favicon.png" style="display: inline-block;"> <span>Match Adv</span>
      </a>
    </div>
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-ticket"></i> Promotions <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="<?php echo base_url('promotions'); ?>">Manage</a></li>
            </ul>
          </li>
