...
class Users extends MX_Controller
{
  function __construct()
  {
    ...
    $this->load->model('Dtb_userall','userall');
  }
  public function index()
  {
  	...
  	else
    {
      ...
      $data['view_content'] = 'manageuser';
      $data['view_addoncss'] = array('manageuser_css');
      $data['view_addonjs'] = array('manageuser_js');
      $data['view_addoncustjs'] = array('manageuser_custjs');
