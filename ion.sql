...
-- Dumping data for table iontest.login_attempts: ~2 rows (approximately)
/*!40000 ALTER TABLE `login_attempts` DISABLE KEYS */;
INSERT INTO `login_attempts` (`id`, `ip_address`, `login`, `time`) VALUES
	(1, '127.0.0.1', 'admin', 1532589341),
	(2, '127.0.0.1', 'admin', 1532590155);
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
	(1, '127.0.0.1', 'administrator', '$2y$08$/yPANEkiM9qTkovIXOs8Lu95Y90mWw5CcgTrKFHWWDCmC.NUbbrJG', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1532599016, 1, 'Admin', 'istrator', 'ADMIN', '0'),
	(2, '127.0.0.1', 'tes@mail.com', '$2y$08$VXVDLvSDQjV.V2KnZNXhRuN0DHR0QM6/VPig5qzmyct9xbl5zqu0G', NULL, 'tes@mail.com', NULL, NULL, NULL, NULL, 1532591726, NULL, 1, 'tes', 'tes', 'tes', '123415'),
