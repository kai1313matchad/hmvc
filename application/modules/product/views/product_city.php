			...
			<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 p-b-50">
				...
				<div class="row mt-3">
					<?php if(count($read_product) > 0) {?>
                      ...
                      <div class="block2-price m0text6 p-r-5"><?= $val['PROD_NAME'];?></div>
											<!-- <?php if ($val['PROD_SPCPRICE'] > 0) {?>
											...
											<?php }?> -->
											<a href="<?php echo base_url();?>product/details/<?php echo $val['PROD_SLUG']?>" class="btn btn-primary mt-3">Detail</a>
										</div>
									</div>
								</div>
							</div>
