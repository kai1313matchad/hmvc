	...
	<!-- Lightbox -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/frontend/vendor/lightbox2/css/lightbox.min.css">
	<link rel="stylesheet" href="<?= base_url()?>assets/frontend/css/homes.css">
	<style>
		body {
			background: rgb(128,44,44);
			background: linear-gradient(90deg, rgba(128,44,44,1) 0%, rgba(184,34,46,1) 50%, rgba(126,44,44,1) 100%);
		}
	</style>